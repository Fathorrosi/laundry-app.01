...
async function generateQRCode() {
    try {
        ...
        fs.writeFileSync('./file/qrcode.txt', qrcodeData);
 ...
 */
async function sendTo(phoneOrContact, message, tgl_masuk, blassType) {
    ...
    try {
        ...
        await page.click('#main > footer > div._2BU3P.tm2tP.copyable-area > div._1SEwr > div > div.p3_M1 > div > div._13NKt.copyable-text.selectable-text');
